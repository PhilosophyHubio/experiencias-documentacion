...
> **Bienvenido** al _README.md_ de nuestro Zine "Rutas de investigación".  
> Los contenidos de esta carpeta son:
> - **Zine_Rutas.md**: Contiene el texto propuesto para este zine.
> - **Z2P1_Digital.pdf:** Versión en PDF, especialmente diseñada para una experiencia de lectura digital óptima.
> - **Z2P1_Impresion.pdf:**  Versión en PDF lista para imprimir, perfecta si prefieres tener el zine en tus manos de manera física.
